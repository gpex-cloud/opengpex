/**
 * LayoutInfoPanel/commands.d.ts — Auto-generated type declarations
 *
...
/** Type map for usePluginCommands<LayoutInfoPanelCommandsMap>() */
export interface LayoutInfoPanelCommandsMap {
