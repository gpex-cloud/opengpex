/**
 * StorageInfoPanel/commands.d.ts — Auto-generated type declarations
 *
...
/** Type map for usePluginCommands<StorageInfoPanelCommandsMap>() */
export interface StorageInfoPanelCommandsMap {
  [key: string]: { execute: (payload: never) => unknown; readonly name: string; readonly shortcutLabel: string };
  toggleCmd: CommandInstance;
  toggleDashboardCmd: CommandInstance;
}
