/**
 * DebugInfoPanel/commands.d.ts — Auto-generated type declarations
 *
...
/** Type map for usePluginCommands<DebugInfoPanelCommandsMap>() */
export interface DebugInfoPanelCommandsMap {
