/**
 * GpexHubPanel/commands.d.ts — Auto-generated type declarations
 *
...
/** Type map for usePluginCommands<GpexHubPanelCommandsMap>() */
export interface GpexHubPanelCommandsMap {
