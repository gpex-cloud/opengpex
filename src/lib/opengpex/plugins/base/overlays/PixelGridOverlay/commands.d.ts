/**
 * PixelGridOverlay/commands.d.ts — Auto-generated type declarations
 *
...
/** Type map for usePluginCommands<PixelGridOverlayCommandsMap>() */
export interface PixelGridOverlayCommandsMap {
  [key: string]: { execute: (payload: never) => unknown; readonly name: string; readonly shortcutLabel: string };
  toggleCmd: CommandInstance;
  hardedgeToggleCmd: CommandInstance;
}
