/**
 * LayerOverlay/commands.d.ts — Auto-generated type declarations
 *
...
/** Type map for usePluginCommands<LayerOverlayCommandsMap>() */
export interface LayerOverlayCommandsMap {
